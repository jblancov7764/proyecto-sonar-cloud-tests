...
class Vista_lista_actividades(QWidget):
    ...
    def mostrar_actividades(self, lista_actividades):
        try:
            ...
            if self.actividades is not None and len(self.actividades) > 0:
                ...
                for item in self.actividades:
                    ...
                    btn_terminar.clicked.connect(partial(self.terminar_actividad, item.id))
                    ...
                    btn_ver_actividad.clicked.connect(partial(self.mostrar_actividad, item.id))
                    ...
                    btn_eliminar.clicked.connect(partial(self.eliminar_actividad, item.id))
    ...
    def mostrar_actividad(self, id_actividad):
        ...
        """
        self.hide()
        self.interfaz.mostrar_actividad(id_actividad)
    ...
    def mostrar_dialogo_insertar_actividad(self):
        ...
        if dialogo.resultado == 1:
            ...
            self.mostrar_actividades(self.cuentasClaras.darActividades())
            self.distribuidor_tabla_actividades.update()
    ...
    def mostrar_dialogo_editar_actividad(self, actividad):
        ...
        dialogo.exec_()
        if dialogo.resultado == 1:
            self.interfaz.editar_actividad(actividad.id, dialogo.texto_nombre.text())
            self.mostrar_actividades(self.cuentasClaras.darActividades())
            self.distribuidor_tabla_actividades.update()
    ...
    def mostrar_dialogo_insertar_viajeros(self, actividad):
        ...
        """
        dialogo = Dialogo_agregar_viajeros(actividad.id)
        dialogo.mostrar_viajeros(self.interfaz.dar_viajeros_en_actividad(actividad.id))
        dialogo.exec_()
        if dialogo.resultado == 1:
